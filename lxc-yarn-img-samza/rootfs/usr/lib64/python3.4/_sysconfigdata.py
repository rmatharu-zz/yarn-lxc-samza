...
build_time_vars = {'ABIFLAGS': 'm',
 ...
 'AR': 'ar',
 'ARFLAGS': 'rc',
 'ASDLGEN': 'python3.4 /builddir/build/BUILD/Python-3.4.2/Parser/asdl_c.py',
 'ASDLGEN_FILES': '/builddir/build/BUILD/Python-3.4.2/Parser/asdl.py '
                  '/Parser/asdl_c.py',
 'AST_ASDL': '/builddir/build/BUILD/Python-3.4.2/Parser/Python.asdl',
 ...
 'BASEMODLIBS': '',
 'BINDIR': '/usr/bin',
 'BINLIBDEST': '/usr/lib64/python3.4',
 ...
 'CC': 'gcc -pthread',
 'CCSHARED': '-fPIC',
 'CFLAGS': '-Wno-unused-result -DDYNAMIC_ANNOTATIONS_ENABLED=1 -DNDEBUG -O2 '
 ...
 'CONFIG_ARGS': "'--build=x86_64-redhat-linux-gnu' "
                ...
                "'LDFLAGS=-Wl,-z,relro  ' 'CPPFLAGS='",
 'CONFINCLUDEDIR': '/usr/include',
 'CONFINCLUDEPY': '/usr/include/python3.4m',
 'COREPYTHONPATH': ':plat-linux',
 'COUNT_ALLOCS': 0,
 'COVERAGE_INFO': '/builddir/build/BUILD/Python-3.4.2/build/optimized/coverage.info',
 'COVERAGE_REPORT': '/builddir/build/BUILD/Python-3.4.2/build/optimized/lcov-report',
 'COVERAGE_REPORT_OPTIONS': '--no-branch-coverage --title "CPython lcov '
                            'report"',
 'CPPFLAGS': '-I. -IInclude -I/builddir/build/BUILD/Python-3.4.2/Include',
 'CXX': 'g++ -pthread',
 'DESTDIRS': '/usr /usr/lib64 /usr/lib64/python3.4 '
             '/usr/lib64/python3.4/lib-dynload',
 'DESTLIB': '/usr/lib64/python3.4',
 'DESTPATH': '',
 'DESTSHARED': '/usr/lib64/python3.4/lib-dynload',
 'DIRMODE': 755,
 ...
 'GRAMMAR_INPUT': '/builddir/build/BUILD/Python-3.4.2/Grammar/Grammar',
 'HAVE_ACCEPT4': 1,
 'HAVE_ACOSH': 1,
 'HAVE_ADDRINFO': 1,
 'HAVE_ALARM': 1,
 ...
 'INCLDIRSTOMAKE': '/usr/include  /usr/include/python3.4m',
 ...
 'LIBPL': '/usr/lib64/python3.4/config-3.4m',
 ...
 'MACHDEP_OBJS': '',
 'MACHDESTLIB': '/usr/lib64/python3.4',
 'MACOSX_DEPLOYMENT_TARGET': '',
 'MAINCC': 'gcc -pthread',
 'MAJOR_IN_MKDEV': 0,
 'MAJOR_IN_SYSMACROS': 0,
 'MAKESETUP': '/builddir/build/BUILD/Python-3.4.2/Modules/makesetup',
 ...
 'PROFILE_TASK': '/builddir/build/BUILD/Python-3.4.2/Tools/pybench/pybench.py '
 ...
 'PYTHON_HEADERS': '\\',
 'PYTHON_OBJS': '\\',
 'PY_CFLAGS': '-Wno-unused-result -DDYNAMIC_ANNOTATIONS_ENABLED=1 -DNDEBUG '
              '-O2 -g -pipe -Wall -Werror=format-security '
              '-Wp,-D_FORTIFY_SOURCE=2 -fexceptions -fstack-protector-strong '
              '--param=ssp-buffer-size=4 -grecord-gcc-switches  -m64 '
              '-mtune=generic -D_GNU_SOURCE -fPIC -fwrapv',
 'PY_CFLAGS_NODIST': '-Werror=declaration-after-statement',
 'PY_CORE_CFLAGS': '-Wno-unused-result -DDYNAMIC_ANNOTATIONS_ENABLED=1 '
                   '-DNDEBUG -O2 -g -pipe -Wall -Werror=format-security '
                   '-Wp,-D_FORTIFY_SOURCE=2 -fexceptions '
                   '-fstack-protector-strong --param=ssp-buffer-size=4 '
                   '-grecord-gcc-switches  -m64 -mtune=generic -D_GNU_SOURCE '
                   '-fPIC -fwrapv -Werror=declaration-after-statement -I. '
                   '-IInclude -I/builddir/build/BUILD/Python-3.4.2/Include  '
                   '-DPy_BUILD_CORE',
 'PY_CPPFLAGS': '-I. -IInclude -I/builddir/build/BUILD/Python-3.4.2/Include',
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': 'LD_LIBRARY_PATH=/builddir/build/BUILD/Python-3.4.2/build/optimized',
 'SCRIPTDIR': '/usr/lib64',
 'SETPGRP_HAVE_ARG': 0,
 'SGI_ABI': '',
 'SHELL': '/bin/sh',
 ...
 'SRC_GDB_HOOKS': '/builddir/build/BUILD/Python-3.4.2/Tools/gdb/libpython.py',
 'STDC_HEADERS': 1,
 ...
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': 'LD_LIBRARY_PATH=/builddir/build/BUILD/Python-3.4.2/build/optimized '
               './python',
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': 'LD_LIBRARY_PATH=/builddir/build/BUILD/Python-3.4.2/build/optimized '
 ...
 'VA_LIST_IS_ARRAY': 1,
 'VERSION': '3.4',
 'VPATH': '/builddir/build/BUILD/Python-3.4.2',
 ...
 'abs_builddir': '/builddir/build/BUILD/Python-3.4.2/build/optimized',
 'abs_srcdir': '/builddir/build/BUILD/Python-3.4.2',
 'datarootdir': '/usr/share',
 'exec_prefix': '/usr',
 'prefix': '/usr',
 'srcdir': '/builddir/build/BUILD/Python-3.4.2'}
